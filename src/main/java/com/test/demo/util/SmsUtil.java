...
public class SmsUtil {
    private static String accessKeyId = "LTAI4Fu8fFGBMi7WvFRSjbDn";
    private static String accessKeySecret = "vDbUXA8kFoTG5zfv71hYVQcy1mXiHW";
    public static void main(String[] args) throws Exception{
        ...
        request.setPhoneNumbers("18871018519");
        //2，必填:短信签名-可在短信控制台中找到
        request.setSignName("验证码");
